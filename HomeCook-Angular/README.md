...
Esta pagina se abre al navegar hasta `http://localhost:4200/account` donde hemos dónde se utilizó el archivo de componentes `account.component.ts`

## Recipe

Esta pagina se abre al navegar hasta `http://localhost:4200/recipe` donde hemos dónde se utilizó el archivo de componentes `recipe.component.ts`
